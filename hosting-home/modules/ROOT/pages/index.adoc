...
In US Cloud, the control plane is physically hosted within the United States. The MuleSoft US Control Plane servers are located in these AWS regions:

[cols="20,20", options="header"]
|===
include::partial$us-control-regions/region.adoc[]
include::partial$us-control-regions/region-name.adoc[]
|===
...
EU Cloud::
+
In the EU Cloud, the control plane is physically hosted within the European Union. The MuleSoft EU Control Plane servers are located in these AWS regions:
+
* Europe (Frankfurt) 
+
`eucentral1`
...
`euwest1`
+
These regions ensure compliance with European Union geo-location based legalities concerning data storage.

Canada Cloud::
+
In the Canada Cloud, the control plane is physically hosted in Canada. The MuleSoft Canada Control Plane servers are located in this AWS region:
+
* Canada (Central) 
+
`cacentral1`
+
This region ensures redundancy and high availability for the MuleSoft Anypoint Platform in Canada.

Japan Cloud::
+
In the Japan Cloud, the control plane is physically hosted in Japan. The MuleSoft Japan Control Plane servers are located in this AWS region:
+
* Asia Pacific (Tokyo) 
+
`apnortheast1`
+
This region ensures redundancy and high availability for the MuleSoft Anypoint Platform in Japan.

MuleSoft Government Cloud::
+
MuleSoft Government Cloud is a FedRAMP-compliant instance of the control plane that's managed by MuleSoft and is suitable for government agencies. The MuleSoft Government Cloud Control Plane servers are located in this AWS region:
+
* US East (N. Virginia) 
+
`useast1`
+
This region ensures redundancy and high availability for the MuleSoft Government Cloud services.
+
