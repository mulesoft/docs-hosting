...
Mule runtime engine 4.3 is bundled with the Runtime Manager agent plugin version 2.4.5. For Runtime Manager Agent compatibility, see xref:release-notes::runtime-manager-agent/runtime-manager-agent-release-notes.adoc[Runtime Manager Agent Release Notes].
