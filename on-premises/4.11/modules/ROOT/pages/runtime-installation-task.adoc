...
Before downloading and installing Mule, verify that you have a xref:general::java-support.adoc#mule-runtime-java-support[supported JDK] installed.
This example uses https://adoptium.net/temurin/releases/?version=17[Eclipse Temurin 17^], which is recommended for Mule 4.9.
...
+
Example for version 4.9.0 in the `Downloads` directory:
+
