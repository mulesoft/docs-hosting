...
An on-premises Mule runtime engine 4.4 with an expired license does not restart. Install a valid Enterprise license before you start the runtime in production.
...
* To verify the license before installing it, run the following command:
+
