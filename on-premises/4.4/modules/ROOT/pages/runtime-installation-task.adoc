...
This example uses https://adoptium.net/temurin/releases/?version=8[Eclipse Temurin 8^], which is recommended for Mule runtime engine 4.4 
...
+
Example for Mule runtime engine 4.4.0 in the `Downloads` directory:
+
