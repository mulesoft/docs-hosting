...
Download the Enterprise standalone distribution (`mule-enterprise-standalone-*.zip`) when you have an Enterprise license. The Mule Kernel (Community Edition) artifact is `mule-standalone-*.zip`. Kernel doesn't accept an Enterprise license and doesn't include clustering.


. Download the Mule 4 binary file from this link and unzip it:
+
https://www.mulesoft.com/lp/dl/anypoint-mule-studio[https://www.mulesoft.com/lp/dl/anypoint-mule-studio]
+
...
You can xref:monitoring::am-installing.adoc[install Anypoint Monitoring] for cloud-managed supported versions of on-premises runtime instances to monitor Mule applications running on that server.
...
* xref:mule-runtime::mule-runtime-updates.adoc[What's New in Mule 4]
