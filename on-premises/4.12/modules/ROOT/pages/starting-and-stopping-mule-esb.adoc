...
:page-aliases: 4.12@mule-runtime::starting-and-stopping-mule-esb.adoc
...
The Java Service Wrapper (Tanuki) didn't receive a ready signal from the JVM before `wrapper.startup.timeout`. See xref:runtime-installation-task.adoc#configure-jvm-memory-and-wrapper-timeouts[Configure JVM Memory and Wrapper Timeouts].
