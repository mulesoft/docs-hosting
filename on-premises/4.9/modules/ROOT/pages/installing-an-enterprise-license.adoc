...
An on-premises Mule runtime engine 4.9 with an expired license does not restart. Install a valid Enterprise license before you start the runtime in production.
