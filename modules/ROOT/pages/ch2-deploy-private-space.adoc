...
File can contain only letters, numbers, and underscores per guidelines on https://docs.oracle.com/javase/specs/jls/se6/html/packages.html#7.7[unique package names].
+
...
* To remove an endpoint, click *X* (*Delete*) in the endpoint row.
