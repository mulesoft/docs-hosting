...
Resource allocation::
+
*This will probably be replaced with just vCores?*
+
See xref:ch2-architecture.adoc#cloudhub-2-replicas[CloudHub 2.0 Replicas].
+
--
...
Logging is enabled by default for apps deployed to private space.
