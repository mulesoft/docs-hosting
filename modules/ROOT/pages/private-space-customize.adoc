...
--
[NOTE]
Runtime Fabric Cloud does not allow you to accept only insecure HTTP requests.

From the *Accept HTTPS requests* list, select one of:
...
... Click *Next*.
... Select an alias from the keystore to add the domains.
... Click *Next*. 
...
== Configure Environments to Associate with the Private Space 
...
== Configure Logging to Associate with the Private Space 
