...
CloudHub 2.0 provides one shared space in each supported xref:ps-gather-setup-info.adoc#region[region], which you deploy your integration applications to.
...
Any of the following requires a private space: 
