...
CloudHub 2.0 provides access to log data that includes deployment messages and events for each worker and Mule runtime engine logs.

////
Logs and diagnostics are currently available only for applications deployed to CloudHub 2.0. 
...
For more advanced searching and log management, you can use Anypoint Monitoring.
...
To view logs for applications deployed to CloudHub 2.0:
