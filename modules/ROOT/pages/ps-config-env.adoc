...
* https://docs.mulesoft.com/access-management/roles.html[Roles]
* https://docs.mulesoft.com/access-management/users#granting-permissions-and-roles-to-users[Granting Permissions and Roles to Users]
