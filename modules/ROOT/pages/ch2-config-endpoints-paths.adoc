...
== Sending Application-to-Application Requests within a Private Space

In private space, every application replica exposes an endpoint inside the the private space. When you enable inbound traffic, that endpoint is exposed externally.
