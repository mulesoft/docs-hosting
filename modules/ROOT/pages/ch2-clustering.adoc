...
Remove persistent queues; point to Anypoint MQ instead?
...
To ensure that you have sufficient resources, see xref:ch2-architecture.adoc#cloudhub-2-0-replicas[CloudHub 2.0 Replicas].
...
See xref:ch2-architecture.adoc#cloudhub-2-0-replicas[CloudHub 2.0 Replicas] for more information about deploying to multiple replicas.
