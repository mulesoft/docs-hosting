...
On applications deployed to xref:managing-applications-on-index.adoc[CloudHub], you can also:
...
What the management panel displays depends on whether your application is deployed on xref:managing-applications-on-index.adoc[CloudHub] or on xref:managing-applications-on-your-own-servers.adoc[your servers]:
