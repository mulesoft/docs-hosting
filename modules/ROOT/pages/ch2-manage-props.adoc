...
See https://docs.mulesoft.com/mule-runtime/4.4/configuring-properties[Configuring Properties^]  (Link out from Beta docs).
...
|`${fullDomain}`|Full domain name of app|`myapp-123456.dr1xpr.usa-w1.cloudhub.io`
|`${application.aws.region}`|App deployment region|`usa-e1`
