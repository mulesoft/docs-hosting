...
. Configure default rules for inbound traffic by selecting the *Protocol* and *Source* from the dropdown lists:
+
--
Protocol::
Protocol type:
...
--
. Configure default rules for outbound traffic by selecting the *Protocol* and *Destination* from the dropdown lists:
+
--
