...
xref:cloudhub-connector::index.adoc#creating-notifications.adoc[Creating a Notification] and
xref:cloudhub-connector::cloudhub-connector-ref.adoc#createNotification[Create Notification]in the connector reference.
--
...
see xref:mule-runtime::error-handling.adoc#on_error_continue[].

== See Also

* xref:cloudhub-connector::index.adoc[CloudHub Connector]
...
////
* xref:runtime-manager::alerts-on-runtime-manager.adoc[]
* https://www.mulesoft.com/exchange/com.mulesoft.connectors/mule-cloudhub-connector/[CloudHub Connector^] on Exchange
