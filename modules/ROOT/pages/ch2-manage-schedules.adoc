...
*Updated to the UI and to align more with https://docs.mulesoft.com/runtime-manager/hybrid-schedule-mgmt[hybrid scheduler] per Martin.*
...
Use Anypoint Studio version 7.13.
...
// ** The *Status* column shows the status of the schedule.
...
Known issue: If you disable scheduler, it still runs when starting an application. If you want to prevent scheduler from running, set the `startdelay` property to five seconds.
