...
*Updated to align more with https://docs.mulesoft.com/runtime-manager/hybrid-schedule-mgmt[hybrid scheduler] per Martin.*

*Last update* 10-Mar-22
...
. Select the checkbox for an element to open the schedule editor in the details pane.
+
...
. Select the element to open the schedule editor in the details pane.
. In the schedule editor, change the schedule or deselect *Enabled* to disable the schedule.
+
<screenshot>
// +
// image::ch2-scheduler-frequency.png[The arrow shows the fixed-frequency schedule configuration in the details pane.]
+
...
<screenshot>
// +
// image::ch2-scheduler-rtm.png[The arrow shows the cron schedule configuration in the details pane.]
. Select the element to open the schedule editor in the details pane.
. In the schedule editor, change the schedule or deselect *Enabled* to disable the schedule.
+
<screenshot>
// +
// image::ch2-scheduler-cron.png[The arrow shows the cron schedule configuration in the details pane.]
...
selecting *Enabled* in the schedule editor in the details pane.
+
<screenshot>
// +
