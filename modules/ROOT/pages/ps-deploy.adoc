...
*** To choose an example app from Anypoint Exchange, select *Choose file > Import file from Exchange*.
+
In the *Get from Exchange* page, enter `hello` in the *Search assets by name*, click *hello-world*, and then click *Select*.
