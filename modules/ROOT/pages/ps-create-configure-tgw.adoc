...
*This topic is updated to the TGW Design Specs dated 08-Nov-21*

*Last update* 17-Feb-22
...
. On the *Create Connection* page, select *Transit Gateway* and enter the xref:ps-gather-setup-info.adoc#transit-gateway-name[name] in the *Connection Name* field.
+
