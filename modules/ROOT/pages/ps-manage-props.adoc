...
You can change the behavior of the app while it's running using properties in either Anypoint Runtime Manager or a properties file.
...
== CloudHub 2.0 Reserved Properties 
