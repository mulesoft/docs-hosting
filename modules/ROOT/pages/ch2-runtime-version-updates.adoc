...
CloudHub 2.0 applies security patches as needed to ensure that your application is secure and updates Mule to maintain the stability of your application.
