...
.2+|<<Static VPN Connection Requirements,Static Routing>>| <<Static IP Prefixes>> 3+|
                                                                                |<<Local ASN>> 3+|
^.^|*_OR_* 4+|
.2+| <<Dynamic VPN Connection Requirements,Dynamic Routing>> | <<Remote ASN>> 3+|
|<<Local ASN>> 3+|
 .4+|Custom Tunnel Configuration
 
 (Optional)   .2+| Tunnel 1 | <<Inside IP CIDRs>> 2+|
                                                | <<Pre-shared Keys>> 2+|
