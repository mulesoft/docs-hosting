...
+
--
* <<private-network-name,Private network name>>
* <<private-network-region,Private network region>>
* <<cidr-block,CIDR block>>
* <<internal-dns-servererver,Internal DNS servers>> (optional)
...
After you create a resource share in AWS, the resource share ID and owner values appear in the resource share page.

You provide these values to connect the AWS transit gateway to Anypoint Platform.
