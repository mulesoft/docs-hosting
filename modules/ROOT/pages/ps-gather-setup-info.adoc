...
The _IP addresses_ specify up to three IP addresses of your internal DNS server.
...
_Domains_ identify the domains to be resolved by the internal DNS server.
...
Select custom tunnel configuration if you want to specify custom values form
