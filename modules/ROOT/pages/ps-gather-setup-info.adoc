...
.5+|*<<advanced-tunnel-configuration,Advanced Tunnel Configuration>>* (_optional_) .2+| Tunnel 1 | <<inside-ip-cidrs,Inside IP CIDR>> 2+|
                                                | <<preshared-keys>> 2+|
              .2+| Tunnel 2 | <<inside-ip-cidrs,Inside IP CIDR>> 2+|
                                                 | <<preshared-keys>> 2+|
    |<<auto-tunnel-initiation,Automatic Tunnel Initiation>> (_first VPN only_) 3+|
.3+|*<<supported-gateway-devices,Gateway Device>>*|Vendor 3+|
|Platform  3+|
|Software  3+|
6+h|Redundant VPN Setup
.13+|| <<vpn-name, VPN name>> 4+|
|<<remote-ip-address>> 4+|
|<<local-asn>> 4+|
|*<<dynamic-vpn-routing,Dynamic Routing Type>>* | <<remote-asn>> 3+|
^.^|*_OR_* 4+|
|*<<static-vpn-routing,Static Routing Type>>* | <<static-ip-prefixes>> 3+|
 .4+|*<<advanced-tunnel-configuration,Advanced Tunnel Configuration>>* (_optional_)   .2+| Tunnel 1 | <<inside-ip-cidrs,Inside IP CIDR>> 2+|
                                                | <<preshared-keys>> 2+|
              .2+| Tunnel 2 | <<inside-ip-cidrs,Inside IP CIDR>> 2+|
                                                 | <<preshared-keys>> 2+|
.3+|*<<supported-gateway-devices,Gateway Device>>*|Vendor 3+|
