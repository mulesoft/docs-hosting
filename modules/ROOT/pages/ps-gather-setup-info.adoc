...
** <<Local ASN>>
** <<Remote ASN>> (<<Dynamic VPN Connection Requirements,dynamic routing>>) or <<Static IP Prefixes>> (<<Static VPN Connection Requirements,static routing>>)  
