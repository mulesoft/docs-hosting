...
|<<Remote IP Address>> 4+|
.5+|Routing Type .2+|  <<Requirements for Static VPN Connections,Static>>  | <<Static IP Prefixes>> 2+|
                              | <<Local ASN>>   2+|
^.^| *_OR_* 3+|
.2+| <<Requirements for Dynamic VPN Connections,Dynamic>> | <<Remote ASN>>  2+|
                              | <<Local ASN>>          2+|
...
== Better Table Format: Information Required to Set Up a Private Space
...
||<<Remote IP Address>> 4+|
.5+| .5+|Routing Type .2+|  <<Requirements for Static VPN Connections,Static>>  | <<Static IP Prefixes>> 2+|
                                                                                |<<Local ASN>> 2+|
|*_OR_* 3+|
.2+| <<Requirements for Dynamic VPN Connections,Dynamic>> | <<Remote ASN>> 2+|
| <<Local ASN>> 2+|
...
** Routing Type
+
***  <<Requirements for Static VPN Connections,Static>>
+
**** <<Static IP Prefixes>>: `10.0.0.0/8`
**** <<Local ASN>>: `64512`
*** <<Requirements for Dynamic VPN Connections,Dynamic>>
+
**** <<Remote ASN>>: `65001`
**** <<Local ASN>>: `64512`
