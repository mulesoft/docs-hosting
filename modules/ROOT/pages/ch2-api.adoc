...
For an interactive reference that includes supported resources, methods, required properties, and expected responses, see the https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/cloudhub-api/[CloudHub 2.0 API^].
...
The following table lists the rate limits for the CloudHub 2.0 management API endpoints except those listed in <<Exceptions to the Global Rate Limits>>.
...
The following table lists the exceptions to the <<Global Rate Limits for the CloudHub 2.0 Management API>>.
...
* https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/cloudhub-api/[CloudHub 2.0 API^]
