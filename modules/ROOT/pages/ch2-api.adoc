...
With Java, use the https://jersey.github.io/[Jersey client^] or https://hc.apache.org/httpclient-3.x/index.html[HttpClient^] with https://github.com/codehaus/jackson[Jackson^] for JSON support.
