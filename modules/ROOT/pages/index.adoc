...
* Proactively scales infrastructure and built-in services to support increasing transaction volumes.
* Allocates CPU and memory based on vCore size to handle performance for applications with varying workloads. 
