...
* See xref:deploying-to-index.adoc[Deploy to CloudHub].
...
See xref:deploying-to-index.adoc#from-anypoint-platform[Deploy an Application from Studio].
...
* xref:managing-applications-on-index.adoc[Manage Applications on CloudHub] has information about settings that are specific to applications on CloudHub.
