...
Logs are stored in the same geolocation to which the corresponding cluster is deployed.
...
CloudHub downloads the Mule log output to a text file.
// `__appName__-instance-__instanceID__-__workerNumber__-mule_ee.log`.
