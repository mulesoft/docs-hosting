...
*** <<configure_public_endpoint,Configure a public endpoint for the app>>. (private space only?)
...
Public endpoint (private space only?)::
+
--
...
TLS Settings (different for shared spaces?)::
* *Last-Mile Security*
+
--
