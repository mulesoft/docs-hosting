...
*This topic is updated to the Private Space (03-Nov) and Private Network (08-Nov) Design Specs*
...
. Enter a xref:ps-gather-setup-info.adoc#private-space-name[name] for your private space and click *Create*. Note that you cannot rename your private space after you create it.
...
. On the *Create Connection* page, select the connection type, enter the xref:ps-gather-setup-info.adoc#vpn-name[name], and click *Next*.
+
