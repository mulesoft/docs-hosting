...
*This topic is updated to the Private Network (09-Nov)/VPN Connections (08-Nov) Design Specs/UI*

*To do: final TGW spec updates*
...
. Click *Save* (or *Save & Restart* if you modified the *Automatic Tunnel Initiation* option) or *Cancel* to close the *Connection Settings* window.
...
include::partial$select-private-space.adoc[tag=selectPrivateSpace]
include::partial$select-private-space.adoc[tag=clickPrivateSpaceName]
. On the *Network* tab, in the *Connections* section, click the VPN menu (*...*) and select *Create Redundanct VPN*:
+
<screenshot>
// +
// image::vpn-view-details.png[View Details option in the VPN menu]
