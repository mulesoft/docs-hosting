...
.. The Anypoint Platform CLI. Run the xref:anypoint-cli::cloudhub-vpc.adoc#cloudhub-vpc-firewall-rules-remove[`cloudhub vpc firewall-rules remove`] command with the index `1` and `3`.
