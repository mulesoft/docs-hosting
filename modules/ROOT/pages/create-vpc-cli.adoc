...
You can use the xref:anypoint-cli::cloudhub-vpc.adoc#cloudhub-vpc-firewall-rules-remove[`vpc firewall-rules remove`] command to remove any of the default rules or you  can add new ones using the xref:anypoint-cli::cloudhub-vpc.adoc#cloudhub-vpc-firewall-rules-add[`vpc firewall-rules add`] command.
