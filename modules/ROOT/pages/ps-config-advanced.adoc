...
. Click *Save* +
A unique service role name is generated, and you can use this role configure to configure identity and access management for AWS. Note that role generation might take a few minutes.
