...
[WARNING]
The app-level egress rules can’t handle domains with completely dynamic IP addresses that constantly change and aren't restricted to a small range of IP addresses.
