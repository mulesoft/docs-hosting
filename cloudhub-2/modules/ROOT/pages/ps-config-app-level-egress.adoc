...
* *Protocol*: HTTPS
* *Destination*: `Custom Domains`
** With the value of the domain name configured in MQ connector URL
+
...
To allow HTTPS connections to Object Store v2, add an app-level egress rule group with the following rules:
