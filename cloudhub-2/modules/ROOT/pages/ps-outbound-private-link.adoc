...
For UBP organizations, each VPC endpoint consumes one network connection entitlement. For core-based organizations, each VPC endpoint consumes one VPN entitlement.
