...
IMPORTANT: When a transit gateway is pending acceptance, all infrastructure updates, such as updates to firewalls, routes, and connections, are delayed until you accept the attachment. Do not make infrastructure changes while the attachment is pending.
