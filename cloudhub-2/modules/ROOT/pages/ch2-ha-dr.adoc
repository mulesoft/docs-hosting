...
Control Plane Availability:: The CloudHub 2.0 management UI and control plane are available in the US East region of North America. It is also available in EU West and Central, Canada, and Japan. For more information, see xref:hosting::index.adoc#control-plane-and-runtime-plane-support-matrix[Control Plane and Runtime Plane Support Matrix].
