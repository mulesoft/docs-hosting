...
Control Plane Availability:: The CloudHub 2.0 management UI and control plane are available in the US East region of North America. They're also available in EU, Canada, and Japan. For more information, see xref:hosting-home::index.adoc#control-plane-and-runtime-plane-support-matrix[Control Plane and Runtime Plane Support Matrix].
...
Control Plane to Runtime Plane Ratio:: Unlike the US (1:12) and EU (1:2) regions, Canada and Japan have a 1:1 control plane region to runtime plane region ratio.
