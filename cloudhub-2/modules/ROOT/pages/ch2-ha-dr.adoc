...
For an overview of HA and DR across all Mule deployment models, and to compare CloudHub 2.0 with other options, see xref:hosting-home::hadr-guide.adoc[High Availability and Disaster Recovery].
...
For more about how to deploy for HA and DR strategies, see xref:hosting-home::hadr-guide.adoc[High Availability and Disaster Recovery].
