...
Applications configured with Horizontal Pod Autoscaling are not limited by the xref:general::pricing.adoc#global-resource-pool-limits[Global Resource Pool Limit].
