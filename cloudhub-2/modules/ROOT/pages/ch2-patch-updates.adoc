...
You can modify or delete your scheduled upgrade if it is not already in progress. If you cancel the schedule and do not create another or opt in to an earlier upgrade, the upgrade occurs during the mandatory patching window.
