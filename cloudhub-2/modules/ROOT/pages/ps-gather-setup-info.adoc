...
When you enter a CIDR block when creating a private space, CloudHub 2.0 checks the value to ensure it does not overlap with another CIDR that is currently in use.
