...
[NOTE]
Each domain can contain uo to 253 characters. When configured with 10 IP addresses (IPs) per entry, the maximum supported capacity is 1940 entries. The system supports more than 1940 entries if you use shorter domain names or fewer IPs in entries.
