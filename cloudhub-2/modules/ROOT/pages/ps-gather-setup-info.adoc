...
[NOTE]
Each domain can have a maximum of 253 characters. Based on this maximum, and the 10 IPs per entry limit, you can add a maximum of 1940 DNS entries. If you use shorter domain names or add fewer IPs, you can add more than 1940 DNS entries.
