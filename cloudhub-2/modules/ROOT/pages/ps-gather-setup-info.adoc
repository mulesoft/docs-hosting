...
Anypoint Platform has a list of CIDRs as an internal CIDR pool for provisioning private space networks that may be subject to change. You can configure the following as reserved CIDR blocks, but you cannot use them as private space network CIDRs:
