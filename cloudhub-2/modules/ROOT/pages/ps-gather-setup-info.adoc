...
[NOTE]
====
These guidelines are subject to change as the platform continues to evolve. If your deployment exceeds the recommended thresholds for your CIDR block size, application deployments might fail with errors indicating that pods are unschedulable due to unavailable nodes.
====
