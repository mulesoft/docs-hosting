...
As a workaround, you can create CNAME records on your own DNS servers, redirecting a permitted custom domain to the restricted domain you want to add. See https://help.salesforce.com/s/articleView?id=001119691&type=1[Cannot add certain domains to CloudHub VPC Internal DNS].
