W-12660383= Assigning Permissions
...
* Assigning the *Create Application* role to a user also gives the *Read Applications* role that is required to deploy applications.
