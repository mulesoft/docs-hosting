...
include::partial$us-control-regions/dns-record.adoc[]
include::partial$us-control-regions/internal-dns-record.adoc[]
|===
...
| US East (N. Virginia) | `<app>.<space-id>.usa-e1.cloudhub.io` | `<app>.internal-<space-id>.usa-e1.cloudhub.io`
| US East (Ohio) | `<app>.<space-id>.usa-e2.cloudhub.io` | `<app>.internal-<space-id>.usa-e2.cloudhub.io`
