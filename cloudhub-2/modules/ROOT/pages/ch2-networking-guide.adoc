...
The DNS record and the load balancer for your integration can change depending on the region you deploy your applications in.

For the runtime regions available for each control plane, including the *Region* token used in DNS records, see xref:ch2-architecture.adoc#regions-and-dns-records[Runtime Plane Regions and DNS Records].
...
* xref:ch2-architecture.adoc#regions-and-dns-records[Runtime Plane Regions and DNS Records]
