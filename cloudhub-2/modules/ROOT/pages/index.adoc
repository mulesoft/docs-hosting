...
When deploying to any of the Hyperforce supported regions, do not delete the egress traffic default route, `0.0.0.0`. Deleting the default egress traffic route can result in Monitoring not to work in CloudHub 2.0.
