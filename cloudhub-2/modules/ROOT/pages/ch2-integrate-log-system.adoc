...
* https://help.salesforce.com/s/search-result?language=en_US#q=mulesoft%20cloudhub%20log4j&t=allResultsTab&sort=relevancy&f:@objecttype=[KBKnowledgeArticle]&f:@sflanguage=[en_US]CloudHub Log4j Knowledge Articles]