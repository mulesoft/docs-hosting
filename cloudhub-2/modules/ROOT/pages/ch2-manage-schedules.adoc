...
* By default, schedulers use the same time zone as the machine on which Mule is running. You can change it by adding the time zone you want. For more information, see xref:code-builder::acb-component-scheduler.adoc#cron-expressions[Cron Expressions]. 
