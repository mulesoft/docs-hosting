...
* For a fixed-frequency scheduler, the minimum recommended start delay is five seconds. For more information, see xref:cloudhub-2::ch2-manage-schedules.adoc#disable-enable-scheduler[].
