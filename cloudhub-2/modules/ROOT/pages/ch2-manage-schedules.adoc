...
* By default, schedulers use the same timezone as the machine on which Mule is running. You can change it by adding the timezone you want. For more information, see xref:docs-code-builder::acb-component-scheduler.adoc#cron-attributes[Cron Attributes]. 
