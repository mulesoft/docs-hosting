...
When you modify HTTP requests, applications aren't reachable for up to 5 seconds.
...
+
The default read-response timeout is 300 seconds. Configure this value up to 3600 seconds (1 hour).
+
