...
For more information, see xref:https://help.mulesoft.com/s/article/Unable-to-re-deploy-a-Cloudhub-2-0-app-that-uses-API-Autodiscovery-and-has-a-Protected-Property[Unable to re-deploy a Cloudhub 2.0 app that uses API Autodiscovery and has a Protected Property].
