...
Use Anypoint VPN to create a secure connection between a private space in CloudHub 2.0 and your on-premises network. You can create multiple site-to-site VPNs if required.
...
[NOTE]
A maximum of 95 route table entries are permitted per private space, regardless of the number of VPN connections. Consolidate networks to the fewest number possible to avoid exceeding the limit.
