...
| North America | Canada (Montreal) | `ca-central-1` | `myapp-uniq-id.can-c1.ca1.cloudhub.io` | -

| https://jp1.platform.mulesoft.com[Japan Cloud]
| Asia Pacific | Japan (Tokyo) | `ap-northeast-1` | `myapp-uniq-id.jpn-e1.jp1.cloudhub.io` | -

| https://in1.platform.mulesoft.com[India Cloud]
| Asia Pacific | India (Mumbai) | `ap-south-1` | `myapp-uniq-id.ind-w1.in1.cloudhub.io` | -
