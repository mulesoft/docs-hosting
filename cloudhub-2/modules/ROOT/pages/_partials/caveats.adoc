...
//tag::softDelete[]
Runtime Manager does not support deploying an application to CloudHub 2.0 or Runtime Fabric if the asset was previously xref:exchange::to-delete-asset.adoc[soft-deleted] in Exchange.
// end::softDelete[]