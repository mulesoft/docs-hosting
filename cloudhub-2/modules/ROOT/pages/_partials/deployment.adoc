...
Starting with Mule 4.5, MuleSoft introduces two new release channels, xref:release_notes::mule-runtime/lts-edge-release-cadence.adoc[Edge and Long-term Support (LTS)].
+
