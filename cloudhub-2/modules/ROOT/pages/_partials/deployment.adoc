...
** *TRACE*: More verbose debugging messages
...
+
include::cloudhub::partial$mule-runtime-eos-note.adoc[]
...
Use Object Store V2::
You can select xref:object-store::index.adoc[Object Store v2] as the implementation by checking the *Use Object Store V2* checkbox.
