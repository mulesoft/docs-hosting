...
use the https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/cloudhub-20-api/minor/1.0/console/method/%234136/[`DELETE <>/organizations/:orgId/transitgateways/:tgw-id`] API call and delete the resources share on AWS.
