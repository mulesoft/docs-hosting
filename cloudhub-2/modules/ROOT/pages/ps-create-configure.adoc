...
.. Optionally, enter your corporate private network's reserved CIDRs to connect to your private space. 
+
When you reserve your corporate CIDRs, Anypoint Platform creates IPs for your private space without using these blocks to prevent conflicts with your corporate private network. 
.. Click *Create*.
--
