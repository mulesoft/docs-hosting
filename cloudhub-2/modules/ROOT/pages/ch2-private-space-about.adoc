...
When deploying an app to the private space, you can use the domains from the TLS contexts to configure multiple external endpoints, which clients use to reach the app from the internet.
