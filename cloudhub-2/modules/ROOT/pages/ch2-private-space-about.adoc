...
Private space network traffic metrics aren't available in Anypoint Monitoring. For application-level traffic metrics, see xref:monitoring::am-faq.adoc#metrics-api-traffic-attributes[What attributes should I use to query application traffic data via the Metrics API?] and https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/metrics-api/[Anypoint Monitoring Metrics API].
