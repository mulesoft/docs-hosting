...
[NOTE]
====
CloudHub 2.0 private space ingress support for TLS cipher version 1.1 ends starting January 15, 2025. Don’t use the following TLS 1.1 ciphers after that date:
```
