...
.. Create a CNAME record pointing to your CloudHub application domain using the {subdomain} pattern and use your company’s "vanity" domain.
...
* https://www.whois.com/[Whois^] (Link out from Beta docs)
