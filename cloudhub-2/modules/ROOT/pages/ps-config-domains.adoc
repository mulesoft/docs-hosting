...
Private DNS targets use private static IP addresses that don't change during the lifetime of the private space. For more information about IP addresses and ranges, see xref:ch2-networking-guide.adoc#ip-ranges[IP Ranges].
