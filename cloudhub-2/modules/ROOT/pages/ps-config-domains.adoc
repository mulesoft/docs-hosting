...
[NOTE]
====
Starting Jan 15, 2025, CloudHub 2.0 private space ingress will no longer support TLS cipher version 1.1. Therefore, the following TLS 1.1 ciphers will be deprecated:
```
