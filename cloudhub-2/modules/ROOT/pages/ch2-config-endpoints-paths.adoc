...
include::partial$select-private-space.adoc[tag=clickSettings]
. Click the *Ingress* tab.
. In the *Endpoint* section, view or copy the endpoint labeled *Default* and *Internal*.
+
image::default-internal-endpoint.png[Endpoint section showing the default internal endpoint for an application]
