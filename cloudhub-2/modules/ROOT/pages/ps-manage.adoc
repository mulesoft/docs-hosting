...
You cannot remove routes for existing private spaces (created before March 8, 2023). You must create and configure a new private space to remove the default routes that MuleSoft provides.
