...
You can remove the default routes that MuleSoft provides. However, when you change the default route, your private space might experience down time. If the *X* icon doesn't appear for a route, you can't remove it. Additionally, private spaces created before March x, 2023 cannot remove MuleSoft's default routes.
