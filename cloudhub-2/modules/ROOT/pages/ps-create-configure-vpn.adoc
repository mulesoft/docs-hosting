...
If you have an existing Anypoint VPN, change the remote IP to repurpose the VPN for use with CloudHub 2.0. For more information, see the xref:cloudhub-1::vpn-about.adoc[Anypoint VPN documentation].
