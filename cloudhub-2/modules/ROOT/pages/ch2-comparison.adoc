...
* The grace period for CloudHub applications is two minutes, whereas, the grace period for CloudHub 2.0 applications is five minutes. For more information, see: xref:ch2-deploy.adoc#grace-period[Grace Period].
