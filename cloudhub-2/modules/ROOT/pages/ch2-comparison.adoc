...
* Applications now have xref:ch2-config-endpoints-paths.adoc[external and internal endpoints] by default. You can also configure multiple external endpoints. You can access the endpoint addresses in Runtime Manager.
