...
The platform controls this behavior with the feature flag `app_mgr_quotas_app_name_uniqueness_enabled`. You can't configure it. Contact MuleSoft Support to confirm whether your organization has the feature enabled.
====
