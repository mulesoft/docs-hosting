...
During rebalancing, a maximum of 30% of an application's replicas are rebalanced concurrently. The system rounds up this percentage to the number of replicas that can be disrupted. For example, if you have ten replicas, a disruption can affect more than three replicas, exceeding the configured 30%.
