...
If the compute infrastructure suffers a failure, the platform moves your application to a healthy infrastructure and restarts the application replicas to ensure availability.

== Infrastructure Maintenance

CloudHub 2.0 moves application replicas running on a compute infrastructure that becomes impaired or end-of-life onto a new infrastructure to ensure availability.
