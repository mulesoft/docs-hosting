...
+
The TCP URL format has the structure: {application-url}.{environment}.tcp.cloudhub.io:{port}. You can't add "internal-" to the {environment}, as CloudHub 2.0 do not support internal endpoints for TCP applications.