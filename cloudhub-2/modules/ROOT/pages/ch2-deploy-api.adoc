...
* When you specify more than ten ports: `App <name> has leased the maximum number of ports.`
* When the port you specify is out of range: `Ports must be within the supported range of 30500 - 32500`
* When the port you specify is in use by another app: `Port 30501 is already in use by other owner`
