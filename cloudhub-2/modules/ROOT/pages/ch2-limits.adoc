...
SMTP traffic:: 20 emails per hour. Outbound traffic on port 25 (SMTP) is blocked by default as a spam prevention measure. For security reasons, use SMTP ports 465 or 587.
