...
| North America | Canada (Montreal) | can-c1 | `cloudhub-ca-central-1` | `myapp-_uniq-id_._shard_.can-c1.ca1.cloudhub.io` | `Cloudhub-CA-Central-1`

| https://jp1.platform.mulesoft.com[Japan Cloud]
| Asia Pacific | Japan (Tokyo) | jpn-e1 | `cloudhub-ap-northeast-1` | `myapp-_uniq-id_._shard_.jpn-e1.jp1.cloudhub.io` | `Cloudhub-AP-Northeast-1`
