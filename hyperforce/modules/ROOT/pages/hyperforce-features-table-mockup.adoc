...
== Option 3: Nested Tabs (Geographic Region > Cloud)

Outer tabs group by geographic region (Americas, EMEA, APAC). Inner tabs drill down to individual cloud regions. This is a prototype using only Americas to test whether nested `[tabs]` blocks render correctly.

NOTE: This uses `=====` (5 equals signs) for the inner tab delimiter. Whether this renders as nested tabs depends on the Antora UI tabs extension version in use.
...
+
--
_See Option 1 or Option 2 for full EMEA data. This section is a placeholder to demonstrate the outer tab structure._
--

APAC::
+
--
_See Option 1 or Option 2 for full APAC data. This section is a placeholder to demonstrate the outer tab structure._
--
====
