...
* xref:api-manager::using-api-alerts.adoc[Reviewing Alerts Concepts]
| API Analytics | Not planned | Not planned
| API Alerts | Available | Available
| API Manager 1.x | Not planned | Not planned
| API Manager 2.x | Available | Available
| API Console Proxy/Trusted Domains | Available | Available
...
| xref:api-experience-hub::index.adoc[API Experience Hub] | n/a | Available | Planned | n/a
...
.2+| Americas
| https://anypoint.mulesoft.com[US Cloud] | `anypoint.mulesoft.com` | Available

| https://ca1.platform.mulesoft.com[Canada Cloud] | `ca1.platform.mulesoft.com` | Available

.2+| Europe
| https://eu1.anypoint.mulesoft.com[EU Cloud] | `eu1.anypoint.mulesoft.com` | Available
