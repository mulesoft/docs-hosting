...
.12+| xref:monitoring::index.adoc[Anypoint Monitoring] | Advanced Alerts | Planned | Planned .11+a| For details, refer to:
...
.12+| xref:monitoring::index.adoc[Anypoint Monitoring] | Advanced Alerts | Planned .11+a| For details, refer to:
...
.12+| xref:monitoring::index.adoc[Anypoint Monitoring] | Advanced Alerts | Planned | Planned .13+a| For details, refer to:
