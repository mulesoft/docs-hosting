...
| xref:hybrid-standalone::index.adoc[Hybrid Standalone Deployment] | n/a | Available | Available | n/a
...
| xref:hybrid-standalone::index.adoc[Hybrid Standalone Deployment] | n/a | Available | Available | Available | n/a
...
* xref:hosting-home::hadr-guide.adoc[High Availability and Disaster Recovery Across Deployment Models]
