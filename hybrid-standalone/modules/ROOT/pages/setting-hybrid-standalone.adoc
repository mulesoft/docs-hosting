...
Configure memory settings, environment variables, and connection properties through the `wrapper.conf` file. For configuration options, see xref:mule-runtime::configuring-properties.adoc[Configuring Properties] and xref:mule-runtime::about-mule-configuration.adoc[Mule Configuration File].
