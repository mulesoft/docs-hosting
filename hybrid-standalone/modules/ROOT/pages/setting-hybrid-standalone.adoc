...
* Download and install Mule runtime engine +
Download the appropriate Mule version and set up your environment with proper configuration. For detailed installation instructions, see xref:on-premises::runtime-installation-task.adoc[Download, Install, Configure, and Upgrade On-Premises Mule Runtime Engine].

* Configure runtime properties and settings +
Configure memory settings, environment variables, and connection properties through the `wrapper.conf` file. For configuration options, see xref:mule-runtime::configuring-properties.adoc[Configuring Properties] and xref:mule-runtime::about-mule-configuration.adoc[Mule Configuration File]. To point Mule at a non-US Cloud control plane, see xref:control-planes::configuring-mule-control-planes.adoc[Configuring Mule to Access Anypoint Platform Control Planes].

* Install enterprise license +
Install your MuleSoft Enterprise license for production deployments. See xref:on-premises::installing-an-enterprise-license.adoc[Install an Enterprise License on On-Premises Mule Runtime Engine] for complete instructions.

* Run Mule as a service +
Configure Mule as a system service for automatic startup and management. See xref:on-premises::runtime-installation-task.adoc[Download, Install, Configure, and Upgrade On-Premises Mule Runtime Engine] for service installation instructions.

* Harden your installation +
Apply security best practices for production environments. See xref:on-premises::hardening-your-mule-installation.adoc[Harden Your On-Premises Mule Runtime Engine Installation] for security configuration guidance.
