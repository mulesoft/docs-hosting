...
Download the appropriate Mule version and set up your environment with proper configuration. For detailed installation instructions, see xref:mule-runtime::runtime-installation-task.adoc[Download, Install, Configure, and Upgrade Mule].
...
Install your MuleSoft Enterprise license for production deployments. See xref:mule-runtime::installing-an-enterprise-license.adoc[Install an Enterprise License] for complete instructions.

* Run Mule as a service +
Configure Mule as a system service for automatic startup and management. See xref:mule-runtime::runtime-installation-task.adoc[Download, Install, Configure, and Upgrade Mule] for service installation instructions.

* Harden your installation +
Apply security best practices for production environments. See xref:mule-runtime::hardening-your-mule-installation.adoc[Hardening your Mule Installation] for security configuration guidance.
