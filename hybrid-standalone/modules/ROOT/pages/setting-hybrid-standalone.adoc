...
* Register servers with Anypoint Platform
...
* Get the appropriate Mule runtime version from Anypoint Exchange for your environment
...
Use Runtime Manager to register your servers with Anypoint Platform, enabling centralized management and deployment. Once registered, you can organize servers into groups or clusters and deploy applications to them.

=== Deployment Target Options

Choose from three deployment configurations:

* xref:creating-servers.adoc[Creating Servers] +
Individual server instances for simple deployments, ideal for development and testing
* xref:creating-servers-groups.adoc[Creating Server Groups] +
Multiple servers managed together for load distribution with completely isolated application instances
* xref:creating-clusters.adoc[Creating Clusters] +
High-availability configuration with automatic failover, load balancing, and synchronized node communication
