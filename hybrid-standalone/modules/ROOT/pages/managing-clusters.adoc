= Managing Cluster
:page-aliases: runtime-manager::cluster-add-srv.adoc, runtime-manager::cluster-del-srv.adoc, runtime-manager::cluster-delete.adoc
...
. In the confirmation window, select the checkbox to verify that you want to delete the cluster, then click *Delete Cluster*.
