= Managing Servers
:page-aliases: runtime-manager::servers-settings.adoc, runtime-manager::servers-actions.adoc, runtime-manager::servers-properties-view.adoc, runtime-manager::servers-properties-create.adoc runtime-manager::servers-cert-renewal.adoc
...
If the *Renew Certificate* option in the *Actions* pull-down menu isn't available after performing the previous steps, xref:installing-and-configuring-runtime-manager-agent#update-the-agent.adoc[update your *Agent* version].
